...
# Reading Dataset:
dataset = pd.read_csv("C:\\Users\\chelimela roshini\\Downloads\\Liver-Disease-Prediction-Project-main\\Liver-Disease-Prediction-Project-main\\Dataset\\Liver_data.csv")
